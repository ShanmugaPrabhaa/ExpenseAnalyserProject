...
$query = "SELECT * FROM goals WHERE user_id = ? and target_amount = current_amount";
...
<body>
    ...
    <main id="main" class="main">
        <div class="container">
            <h1>Push Goal Success</h1>
            <button onclick="sendNotification('beforetarget.php')">Send Goal Success Email</button>
            <table>
                <thead>
                    <tr>
                        <th> User Id</th>
        ...
        <script>
            function sendNotification(action) {
                ...
                xhr.open("POST", "beforetarget.php", true);
