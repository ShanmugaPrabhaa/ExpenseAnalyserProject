...
$stmt = $conn->prepare("SELECT u.fullname, u.username, u.email, r.roleName
    FROM Users u
    JOIN Roles r ON u.role_id = r.role_id
    WHERE u.user_id = ?");
$stmt->bind_param("i", $user_id);
$stmt->execute();
$stmt->bind_result($fullname, $username, $email,$role_name);
$stmt->fetch();
$stmt->close();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("UPDATE Users SET fullname = ?, username = ?, email = ? WHERE user_id = ?");
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-9 col-md-8"><?php echo $role_name; ?></div>
                  </div>
